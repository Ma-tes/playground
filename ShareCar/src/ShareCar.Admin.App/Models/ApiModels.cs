...
public sealed record VehicleItem(int Id, string Model, string PlateNumber, int? CurrentParkingLotId, string Status, int Odometer);

public sealed record ParkingLotItem(int Id, string Name, double Latitude, double Longitude, int TotalCapacity, int AvailableVehicles);
